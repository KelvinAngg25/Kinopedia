...
public class BundleCODM extends JFrame {
    ...
    private final String currencyName = "CP";
    private final ImageIcon currencyIcon = loadIcon("/Kinopedia/model/IMAGESS/CPs-CODM.png", 18, 18);
