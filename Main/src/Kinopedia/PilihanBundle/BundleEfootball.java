...
public class BundleEfootball extends JFrame {
    ...
    private final String currencyName = "eFootball Gold";
    private final ImageIcon currencyIcon = loadIcon("/Kinopedia/model/IMAGESS/efootballgoldss.png", 18, 18);
    private final ImageIcon logoFooter   = loadIcon("/Kinopedia/model/IMAGESS/LogoKinopedia.png", 70, 70);

    public BundleEfootball(JFrame backTo) {
        this.backTo = backTo;
