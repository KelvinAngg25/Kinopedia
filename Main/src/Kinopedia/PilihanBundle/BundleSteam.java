...
public class BundleSteam extends JFrame {
    ...
    public BundleSteam(JFrame menuSebelumnya) {
        ...
        // Memuat ikon Steam Wallet / Credits dan Logo Kinopedia
        ikonMataUang = muatGambar("/Kinopedia/model/IMAGESS/Steam-credits.png", 25, 25);
...
//        guliran.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        // Memasukkan daftar harga khusus Steam Wallet Code / Credits
