...
public class BundleFF extends JFrame {
    ...
    public BundleFF(JFrame menuSebelumnya) {
        ...
        // Memuat ikon Diamond Free Fire dan Logo Kinopedia
...
//        guliran.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        areaBundle.add(Box.createVerticalStrut(-20)); // Efek overlap figma
        ...
        // Memasukkan daftar harga khusus Diamonds Free Fire
        buatKartu(panelGrid, "12 Diamonds", "Rp 1.802");
        buatKartu(panelGrid, "70 Diamonds", "Rp 9.000");
        buatKartu(panelGrid, "355 Diamonds", "Rp 45.000");
        buatKartu(panelGrid, "1450 Diamonds", "Rp 180.100");
        buatKartu(panelGrid, "3640 Diamonds", "Rp 450.300");
        buatKartu(panelGrid, "7290 Diamonds", "Rp 901.000");
        buatKartu(panelGrid, "36500 Diamonds", "Rp 4.504.000");
        buatKartu(panelGrid, "73100 Diamonds", "Rp 9.010.000");
