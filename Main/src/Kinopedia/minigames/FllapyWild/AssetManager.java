...
public class AssetManager {
    ...
    public static void loadAll() {
        ...
        // BACKGROUND — sky pakai .jpg sesuai file asli
        load("sky",    "background/sky.jpg");
        load("ground", "background/ground.png");

        // KARAKTER — folder "character" (tanpa s), hanya 2 frame
        for (String name : new String[]{"pluppy", "boyo", "kwek"}) {
            load(name + "_1", "character/" + name + "_1.png");
            load(name + "_2", "character/" + name + "_2.png");
            // Frame 3 pakai frame 1 lagi supaya animasi tetap jalan
            images.put(name + "_3", images.get(name + "_1"));
        }
